...
console.log("After removing last item,the array is: "+ arr);
console.log("------");
...
console.log("evenArr is: "+ evensArr)
console.log("------");
////////// PROBLEM 5 //////////
...
//. (Hint: how can you make sure that your code works for exactly 7 elements? What index do you use 
